...
Welcome to `llm2geneset` contributor's guide.
...
If you experience bugs or general issues with `llm2geneset`, please have a look
...
You can help improve `llm2geneset` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`llm2geneset` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `llm2geneset`'s files. While this mechanism can
...
```
conda create -n llm2geneset python=3 six virtualenv pytest pytest-cov
conda activate llm2geneset
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/llm2geneset.git
   cd llm2geneset
   ```
...
5. Install [pre-commit]:
   ...
   `llm2geneset` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/llm2geneset
[issue tracker]: https://github.com/<USERNAME>/llm2geneset/issues
